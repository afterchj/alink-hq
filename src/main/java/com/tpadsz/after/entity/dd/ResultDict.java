...
public enum ResultDict {
    ...
    NO_SCENE("301", "该用户或网络下没有创建场景"), NO_GROUP("302", "该用户或网络下没有创建组"),PROJECT_EXISTED("303", "名下有项目，跳转"),NOT_SAME_COMPANY("304", "不是同一个公司的账号"),ACCOUNT_NOT_EXISTED("305", "该账号不存在"),REPEAT_NAME("306", "该项目名已存在"),REPEAT_SCENE_NAME("307", "该场景名已存在");
