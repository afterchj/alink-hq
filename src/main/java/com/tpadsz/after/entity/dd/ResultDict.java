...
public enum ResultDict {
    ...
    ACCOUNT_NOT_CORRECT("101", "账号不存在！"), PASSWORD_NOT_CORRECT("102", "账号密码不正确！"), MOBILE_NOT_EXISTED("103", "该手机号未绑定！"), ACCOUNT_DISABLED("104", "该账号已禁用！"),ACCOUNT_LOCKEED("105", "该账号在别处登入！"),
